...
In this situation, the acceptance follows a Boltzmann factor whose value is stored in a $\text{double}$.
Using the $\text{rand()}$ function again, I created a randomised $r$ value for each iteration of the algorithm,
and when $r$ is less than the acceptance probability (Boltzmann factor), the spin flip is successful.\medbreak
